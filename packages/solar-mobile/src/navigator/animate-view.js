  ...
  initScreenPerformance(ReduxComponent, shouldResetRedux) {
    ...
    if (!Component[PAUSE]) {
      ...
      Component.prototype.componentWillMount = function(...params) {
        ...
        componentWillMount.apply(this, ...params);
      };
      Component.prototype.shouldComponentUpdate = function(...params) {
        if (Queues.indexOf(this)<0 && thisContext.isAnimating) {
          Queues.push(this);
        }
        return thisContext.isAnimating ? false:shouldComponentUpdate.apply(this, ...params);
      };
    }
  }
