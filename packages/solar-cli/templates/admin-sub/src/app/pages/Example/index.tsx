...
import model, { ModelProps, ModelRecord } from './model';
...
@store.connect(model)
export default class ExamplePageView extends AdminPage<ModelProps> {
  // 列表搜索字段
  ...
  // 操作按钮
  get buttons(): AbstractButtons<ModelRecord> {
    return [
