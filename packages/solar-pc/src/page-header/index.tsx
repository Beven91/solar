...
import { Avatar, ConfigProvider, AvatarProps, Space, Breadcrumb, BreadcrumbProps, TagType } from 'antd';
...
const renderBack = (
  ...
  return (
    <div className={`${prefixCls}-back`.trim()}>
      <div
        role="button"
        onClick={(e) => {
          onBack?.(e);
        }}
        className={`${prefixCls}-back-button`.trim()}
        aria-label="back"
      >
        {backIcon}
      </div>
